...
Later in development they [switched](https://hytale.com/news/2022/7/summer-2022-development-update) from C#/Java to C++. While having most employees being Java mod developer for minecraft. They had to build new system, learn new knowledge and had to throw away the code the build before. 
