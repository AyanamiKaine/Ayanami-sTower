...
tags: ["Interpreter", "Programming", "FORTH", "Concatenative Language", "Stack Language"]
...
Because we can compile C# to Wasm you can even play with it here!
...
Stella comes with a rich set of built-in words including:
