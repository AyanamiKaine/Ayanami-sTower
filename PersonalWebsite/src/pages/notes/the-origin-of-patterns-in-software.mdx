...
A fantastic read I only can recommend, It's just a bit ... long. The four volumes are around 2100 pages. Sadly to my feeble mind its unclear how the laid out in Nature of Order can be used in programming.
