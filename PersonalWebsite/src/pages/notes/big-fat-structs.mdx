...
So should every program have one type of big-fat-struct? No I generally don't think so. But maybe every module/library should have. Mixing it with [opaque pointers](./opaque-pointers.mdx) and exposing a capability struct could be useful. But I have to do more research on that idea. Also see the [definitive guide for software design](../posts/definitive-guide-for-software-design.mdx) the part about API design.