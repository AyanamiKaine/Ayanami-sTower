...
public static class EcsWorldExtensions
{
    ...
    /// </remarks>
    public static void Match<Tag>(this World world, Dictionary<string, object> queryData)
    {
    ...
    /// <summary>
    /// Matches rules stored in the ECS world against provided query data and executes the payload of the best matching rule.
    /// </summary>
    /// <param name="world">The ECS world containing the rules to evaluate.</param>
    ...
    public static void Match(this World world, Dictionary<string, object> queryData)
    {
        var acceptedRules = new List<Rule>();
        var currentHighestScore = 0;
