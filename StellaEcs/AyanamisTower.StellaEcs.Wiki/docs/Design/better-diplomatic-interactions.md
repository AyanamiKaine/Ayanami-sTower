...
# Better Diplomatic Interactions

There is a major problem with diplomatic interactions that take time. A perfect example can be seen in Europa Universalis V and its [hundred years war](https://eu5.paradoxwikis.com/Situations#Hundred_Years'_War). Here it is possible for England to rule over France with a personal union. In Europa Universalis IV a personal union was simply a different vassal type. In EU5 it's a [bit more complex](https://eu5.paradoxwikis.com/International_organization#Union) (but the details don't matter here). 
