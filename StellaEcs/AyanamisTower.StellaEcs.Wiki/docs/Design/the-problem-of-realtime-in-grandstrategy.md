...
# The Problem with Realtime in Grand Strategy Games
...
A possible solution could be interleaving realtime with turn time. What do I mean with that? We could end a turn and forward 30 days and should something important happen in the mean time (like a war declaration) we would end the turn prematurly at lets say 14 days (day of declaration) instead.
