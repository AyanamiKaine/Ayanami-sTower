...
namespace Fluid_HTN.UnitTests
{
    ...
    public class SelectorTests
    {
        ...
        public void DecomposeCompoundSubtaskWinOverLastMTR_ExpectedBehavior()
        {
            ...
            task3.AddSubtask(
                new PrimitiveTask() { Name = "Sub-task3-1" }.AddCondition(
                    new FuncCondition<MyContext>("Done == true", context => context.Done == true)
                )
            );
            ...
            task2.AddSubtask(
                new PrimitiveTask() { Name = "Sub-task2-1" }.AddCondition(
                    new FuncCondition<MyContext>("Done == true", context => context.Done == true)
                )
            );
            ...
            task.AddSubtask(
                new PrimitiveTask() { Name = "Sub-task1-1" }.AddCondition(
                    new FuncCondition<MyContext>("Done == false", context => context.Done == false)
                )
            );
