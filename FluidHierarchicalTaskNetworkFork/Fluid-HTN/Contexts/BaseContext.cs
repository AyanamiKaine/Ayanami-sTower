...
namespace FluidHTN.Contexts
{
    public abstract class BaseContext : IContext
    {
        ...
        public List<int> MethodTraversalRecord { get; set; } = [];
        public List<int> LastMTR { get; } = [];
        ...
        public Queue<PartialPlanEntry> PartialPlanQueue { get; set; } =
            new Queue<PartialPlanEntry>();
        ...
        public virtual void Init()
        {
            ...
            {
                WorldStateChangeStack = new Stack<KeyValuePair<EffectType, byte>>[
                    WorldState.Length
                ];
        ...
        )
        {
            ...
            DecompositionLog.Enqueue(
                new DecomposedCompoundTaskEntry
                {
                    Name = name,
