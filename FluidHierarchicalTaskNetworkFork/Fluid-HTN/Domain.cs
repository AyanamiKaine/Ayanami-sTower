...
namespace FluidHTN
{
        ...
        where T : IContext
    {
        ...
        public DecompositionStatus FindPlan(T ctx, out Queue<ITask> plan)
        {
            ...
            {
                throw new Exception(
                    "We require the Method Traversal Record to have a valid instance."
                );
            }
        ...
        /// <returns></returns>
        private DecompositionStatus OnReplanDuringPartialPlanning(
            T ctx,
            ref Queue<ITask> plan,
        ...
        /// </summary>
        /// <param name="ctx"></param>
        private static void ClearMethodTraversalRecord(T ctx)
        {
        ...
        /// <param name="status"></param>
        /// <returns></returns>
        private static bool HasDecompositionFailed(DecompositionStatus status)
        {
        ...
        /// <param name="status"></param>
        /// <returns></returns>
        private static bool HasDecompositionSucceeded(DecompositionStatus status)
        {
        ...
        /// <param name="status"></param>
        /// <returns></returns>
        private DecompositionStatus OnPausedPartialPlan(
            T ctx,
            ref Queue<ITask> plan,
            DecompositionStatus status
        )
        ...
        private static void EnqueueToExistingPlan(ref Queue<ITask> plan, Queue<ITask> subPlan)
        {
        ...
        /// <param name="ctx"></param>
        /// <returns></returns>
        private static bool HasFoundSamePlan(T ctx)
        {
        ...
        /// </summary>
        /// <param name="ctx"></param>
        private static void ApplyPermanentWorldStateStackChanges(T ctx)
        {
        ...
        /// </summary>
        /// <param name="ctx"></param>
        private static void ClearWorldStateStackChanges(T ctx)
        {
