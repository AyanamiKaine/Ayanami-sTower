...
our sub SDL_Delay(uint32) is native($SDL-LIB) is symbol('SDL_Delay') is export { * }
# For more see: "https://wiki.libsdl.org/SDL3/SDL_GetTicks"
our sub SDL_GetTicks() returns uint64 is native($SDL-LIB) is symbol('SDL_GetTicks') is export { * }
