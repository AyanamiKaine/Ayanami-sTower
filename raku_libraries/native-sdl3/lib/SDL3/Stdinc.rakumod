...
our sub SDL_sin(num64) returns num64 is native($SDL-LIB) is symbol('SDL_sin') is export { * };

# For more see: "https://wiki.libsdl.org/SDL3/SDL_randf"
our sub SDL_randf() returns num32 is native($SDL-LIB) is symbol('SDL_randf') is export { * };
