# For more see: "https://wiki.libsdl.org/SDL3/CategoryStdinc"
unit module SDL3::Stdinc;

use NativeCall;
constant $SDL-LIB = 'SDL3';

# For more see: "https://wiki.libsdl.org/SDL3/SDL_sin"
our sub SDL_sin(num64 $x) returns num64 is native($SDL-LIB, v0) is symbol('SDL_sin') is export { * };
