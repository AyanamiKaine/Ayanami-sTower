...
our sub SDL_SetClipboardText(str) returns bool is native($SDL-LIB, v0) is symbol('SDL_SetClipboardText') is export { * }
# For more see: "https://wiki.libsdl.org/SDL3/SDL_GetClipboardText";
our sub SDL_GetClipboardText() returns str is native($SDL-LIB, v0) is symbol('SDL_GetClipboardText') is export { * }