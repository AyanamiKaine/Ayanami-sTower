                    ...
                    Expanded(
                      child: InfoLabel(
                        ...
                        child: ComboBox<String>(
                          ...
                          items: ['90', '99', '11', '17', '23'].map((version) {
...
// Checkboxes (group related ones)
                ...
                GridView.count(
                  ...
                  childAspectRatio: 4.0, // Adjust aspect ratio for wider items
                  shrinkWrap: true, // Allow GridView to shrink to content size
                  children: [
                    Checkbox(
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    Checkbox(
                      checked: _addLuaJIT,
                      onChanged: (value) => setState(() => _addLuaJIT = value!),
