...
local StellaRequestSocket = {}

function StellaRequestSocket.new(address)
    local self = {} -- Local table to hold the object's state

    -- Private members (only accessible within the module)
    local _socketHandler = StellaMessagingFFI.create_request_socket();
