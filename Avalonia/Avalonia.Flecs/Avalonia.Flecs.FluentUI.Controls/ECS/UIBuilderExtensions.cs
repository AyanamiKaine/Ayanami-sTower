...
public static class UIBuilderExtensions
{
    ...
    public static UIBuilder<NavigationView> SetPaneTitle(
        this UIBuilder<NavigationView> builder,
        string PaneTitle
    )
    {
    ...
    /// </summary>
    public static UIBuilder<NavigationView> OnDisplayModeChanged(
        this UIBuilder<NavigationView> builder,
    ...
    /// <returns></returns>
    public static UIBuilder<NavigationView> OnNavViewSelectionChanged(
        this UIBuilder<NavigationView> builder,
    ...
    /// <returns>The UI builder instance.</returns>
    public static UIBuilder<NavigationViewItem> SetIconSource(
        this UIBuilder<NavigationViewItem> builder,
