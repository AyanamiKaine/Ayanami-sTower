...
The problem is that it is part of the reactive ui library not avalonia itself and
we dont need any other dependency.

See things like OnClick in the UIBuilder for an example usage.
*/
