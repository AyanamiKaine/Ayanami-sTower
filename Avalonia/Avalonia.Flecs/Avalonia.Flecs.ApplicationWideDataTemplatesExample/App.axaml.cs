...
namespace Avalonia.Flecs.ApplicationWideDataTemplatesExample;
...
public partial class App : Application
{
    ...
    public override void Initialize()
    {
        ...
        /* 
        Add the template to the application-wide data templates 
        Now we can remove the data template from the ListBox control
        and the datatemplate will still be available to the ListBox.


        It checks for data templates in the following order:
            1. Current control's DataTemplates collection
            2. Parent control's DataTemplates collection (recursively)
            3. Window's DataTemplates collection
            4. Application's DataTemplates collection (defined in here)

        */
        DataTemplates.Add(listBox.GetItemTemplate()!);
