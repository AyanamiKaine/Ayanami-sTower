...
var result = await db.Entities.OrderBy(b => b.EntityId).FirstAsync();
...
string elapsedTime = string.Format(
    ...
    ts.Seconds,
    ts.Milliseconds
); // More precise than ts.TotalMilliseconds for display
...
var rootWithChildren = await db
    .Entities.Include(e => e.Children) // Load direct children
