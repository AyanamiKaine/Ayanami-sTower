...
public class Location : IComparable<Location>
{
    ...
    public static readonly Location DungeonCell = new("Dungeon Cell");
    public static readonly Location Hallway = new("Hallway");
    public static readonly Location GuardRoom = new("Guard Room");
    public static readonly Location Outside = new("Outside"); // WINNING LOCATION!
...
public class GameSimulation
{
    ...
    private void SetupWorld()
    {
        ...
        _worldState
            .SetValue("PlayerLocation", Location.DungeonCell)
    ...
    private void SetupRules()
    {
        ...
        _gameRules.Add(
            new(
                [new Criteria<string>("GameCommand", "quit", Operator.Equal)],
                () =>
                {
                    Console.WriteLine("\nThanks for playing!");
                    _gameOver = true;
        ...
        _gameRules.Add(
            new(
                [new Criteria<string>("GameCommand", "help", Operator.Equal)],
                () =>
                    Console.WriteLine(
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "look", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.DungeonCell, Operator.Equal),
                ],
                () =>
                    Console.WriteLine(
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "look", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.Hallway, Operator.Equal),
                ],
                () =>
                    Console.WriteLine(
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "look", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.GuardRoom, Operator.Equal),
                    new Criteria<bool>("GuardIsAwake", true, Operator.Equal),
                ],
                () =>
                    Console.WriteLine(
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "look", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.GuardRoom, Operator.Equal),
                    new Criteria<bool>("GuardIsAwake", false, Operator.Equal),
                ],
                () =>
                    Console.WriteLine(
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "take key", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.DungeonCell, Operator.Equal),
                ],
                () =>
                {
                    Console.WriteLine("\nYou search the straw and find a small, rusty key.");
                    _worldState.SetValue("HasRustyKey", true);
                }
            )
            {
                Priority = 10,
        ...
        _gameRules.Add(
            new(
                ...
                () =>
                {
                    ...
                    _worldState.SetValue("HasMainKey", true);
                }
            )
            {
                Priority = 10,
        ...
        _gameRules.Add(
            new(
                ...
                {
                    Console.WriteLine(
                        "\nYou reach for the key, but the guard shouts and raises his axe. You have failed."
                    );
                    _gameOver = true;
                }
            )
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "take rock", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.DungeonCell, Operator.Equal),
                ],
                () =>
                {
                    Console.WriteLine("\nYou pick up a fist-sized rock.");
                    _worldState.SetValue("HasRock", true);
                }
            )
        );
        var item = new Rule(
            [
                new Criteria<string>("GameCommand", "throw rock", Operator.Equal),
                new Criteria<bool>("HasRock", true, Operator.Equal),
                new Criteria<Location>("PlayerLocation", Location.Hallway, Operator.Equal),
            ],
            () =>
            {
                Console.WriteLine(
                    "\nYou throw the rock down the hallway. It makes a loud clatter. You hear the guard in the east room stir and get up to investigate."
                );
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "unlock door", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.DungeonCell, Operator.Equal),
                    new Criteria<bool>("HasRustyKey", true, Operator.Equal),
                ],
                () =>
                {
                    Console.WriteLine(
                    ...
                    _worldState.SetValue("CellDoorUnlocked", true);
                }
            )
            {
                Priority = 10,
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "go north", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.DungeonCell, Operator.Equal),
                    new Criteria<bool>("CellDoorUnlocked", true, Operator.Equal),
                ],
                () =>
                {
                    Console.WriteLine("\nYou open the door and step into a hallway.");
                    _worldState.SetValue("PlayerLocation", Location.Hallway);
                }
            )
            {
                Priority = 10,
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "go east", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.Hallway, Operator.Equal),
                ],
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "go south", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.Hallway, Operator.Equal),
                ],
        ...
        _gameRules.Add(
            new(
                [
                    new Criteria<string>("GameCommand", "go west", Operator.Equal),
                    new Criteria<Location>("PlayerLocation", Location.Hallway, Operator.Equal),
                    new Criteria<bool>("HasMainKey", true, Operator.Equal),
                ],
                () =>
                {
                    Console.WriteLine(
                    ...
                    _worldState.SetValue("PlayerLocation", Location.Outside);
                    _gameOver = true;
                }
            )
            {
